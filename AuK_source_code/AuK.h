 ...
 *
 * TMR1 and int2 are used inside AuK, then it could not be used by the system 
...
/* Returns the number of seconds between two tics of the scheduler timer 
 ...
 * considered instead of the programmed one.*/
float tic_period();
 ...
 * of the "immediate ceiling priority" real time protocol when building 
 ...
 * second parameter. 
 * To adhere to the immediate ceiling priority protocol, it is necessary 
